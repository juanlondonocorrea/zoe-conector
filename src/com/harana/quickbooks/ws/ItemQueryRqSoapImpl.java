...
public class ItemQueryRqSoapImpl implements QBWebConnectorSvcSoap {
	...
	public ArrayOfString authenticate(String strUserName, String strPassword) {
		...
		System.out.println("Authenticate strUserName=" + strUserName + ", uuid=" + uuid.toString());
	...
	public String closeConnection(String ticket) {
		System.out.println("closeConnection ticket="+ticket);
	...
	public String connectionError(String ticket, String hresult, String message) {
		System.out.println("connectionError ticket="+ticket +", hresult=" + hresult + ", message=" + message);
		return null;
	}
	...
	public int receiveResponseXML(String ticket, 
		...
		System.out.println("receiveResponseXML ticket="+ticket +", hresult=" + hresult + ", message=" + message + ", response=" + response);
		return 100;
	}
